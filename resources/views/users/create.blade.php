<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('users.store') }}" class="space-y-6">
                        ...
                        <div id="student_id_field" class="hidden">
    ...
    <script>
        ...
        // Show student ID field if role is already selected (e.g., on form validation errors)
        if (document.getElementById('role').value === 'student') {
            document.getElementById('student_id_field').classList.remove('hidden');
        }
    </script>
</x-app-layout> 